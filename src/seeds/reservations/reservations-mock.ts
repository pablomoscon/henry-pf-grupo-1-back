...
export const reservationsMock: Reservation[] = [
  {
    ...
    checkInDate: new Date('2025-01-09T09:00:00Z'),
    checkOutDate: new Date('2025-01-10T09:00:00Z'),
  ...
  },
  {
    ...
    checkInDate: new Date('2025-01-11T09:00:00Z'),
    checkOutDate: new Date('2025-01-12T09:00:00Z'),
  ...
  },
  {
    ...
    checkOutDate: new Date('2025-01-30T09:00:00Z'),
    status: ReservationStatus.CONFIRMED,
    createdAt: new Date('2025-01-02T09:00:00Z'),
    updatedAt: new Date('2025-01-06T11:00:00Z'),
    totalAmount: 150.0,
